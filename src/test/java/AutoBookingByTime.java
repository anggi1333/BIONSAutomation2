...
public class AutoBookingByTime {
    public static void testbt(WebDriver driver, ExtentTest extentTest, String Stock, String condition, String iftime, String bestorentry,String bos, String pricelot, String lot) {
