...
public class Login {
    public static void  testScenariologin(WebDriver driver, ExtentTest extentTest  ,String SettingEnv, String Username, String Password, String Pin) {
        ...
        if (SettingEnv.equals("DEV")) {
            ...
            WebElement set4 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='PROD']")));
            set4.click();
            ...
            custom2txt.sendKeys("https://funddev.bions.id");





            WebElement microservice = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='MicroService API Server URL']/following-sibling::div//input")));
            microservice.sendKeys(Keys.CONTROL+"A"+Keys.BACK_SPACE);
            microservice.clear();try {
                Thread.sleep(100); // Wait for 0.1 second between clicks
            } catch (InterruptedException e) {
                e.printStackTrace();
                try {
            ...
            microservice.sendKeys("dev.bions.id:8000");
            ...
            if (istutorDisplayed||
                    ismenuNotDisplayed) {
                WebElement g3 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"root\"]/div/div/div/div/div/div[1]/div/div[1]/div[1]/div/div/div[1]/div/div[2]/div[2]/div/div/div/div[1]/div/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div/div/div[1]/div/div[2]/div[2]/div/div/div/div[1]/div/div[1]/div[1]/div/div/div/div/div[1]/div/div/div/div/div[3]/button/div/div")));
                g3.click();
        ...
        else if (SettingEnv.equals("MOCK")|| SettingEnv.equals("mock")) {
...
//            set4.click();
            ...
            if (istutorDisplayed||
                    ismenuNotDisplayed) {
                WebElement g3 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/div[1]/div/div/div/div/div[1]/div/div[1]/div[1]/div/div/div[2]/div[2]/div/div/div/div/div/div/div[1]/div[1]/div/div/div/div/div/div/div/div[2]/div[2]/div/div/div/div[1]/div/div[1]/div[1]/div/div/div/div[2]/div[2]/div/div/div/div[2]/div/div/div/div/div[3]/div/div/div")));
                g3.click();
                WebElement setting2 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[text()='Setting']")));
                setting2.click();
                try {
